...
def main() -> None:
    ...
    parser.add_argument("--models-per-arch", type=int, default=int(os.environ.get("CEI_MODELS_PER_ARCH", "40")))
    ...
    parser.add_argument("--out", default=os.environ.get("CEI_OUT", "jmlr_scale_image_results.csv"))
